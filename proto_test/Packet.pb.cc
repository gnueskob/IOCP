...
extern PROTOBUF_INTERNAL_EXPORT_PacketHeader_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_PacketHeader_PacketHeader_2eproto;
namespace lsbProto {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_Echo_Packet_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, InitDefaultsscc_info_Echo_Packet_2eproto}, {
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_Packet_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::lsbProto::Echo, header_),
...
const char descriptor_table_protodef_Packet_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\014Packet.proto\022\010lsbProto\032\022PacketHeader.p"
  "roto\";\n\004Echo\022&\n\006header\030\001 \001(\0132\026.lsbProto."
  "PacketHeader\022\013\n\003msg\030\002 \001(\tb\006proto3"
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_Packet_2eproto_deps[1] = {
  &::descriptor_table_PacketHeader_2eproto,
};
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_Packet_2eproto = {
  &descriptor_table_Packet_2eproto_initialized, descriptor_table_protodef_Packet_2eproto, "Packet.proto", 113,
...
void Echo::InitAsDefaultInstance() {
  ::lsbProto::_Echo_default_instance_._instance.get_mutable()->header_ = const_cast< ::lsbProto::PacketHeader*>(
      ::lsbProto::PacketHeader::internal_default_instance());
}
class Echo::_Internal {
 public:
  static const ::lsbProto::PacketHeader& header(const Echo* msg);
};

const ::lsbProto::PacketHeader&
Echo::_Internal::header(const Echo* msg) {
  return *msg->header_;
}
void Echo::clear_header() {
...
Echo::Echo(const Echo& from)
  ...
  if (from.has_header()) {
    header_ = new ::lsbProto::PacketHeader(*from.header_);
  } else {
    header_ = nullptr;
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:lsbProto.Echo)
  ...
  if (from.has_header()) {
    mutable_header()->::lsbProto::PacketHeader::MergeFrom(from.header());
  }
}
